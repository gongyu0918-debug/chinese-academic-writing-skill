...
- 版本 0.1.2 在 ANTI-AI 叶中增加完整底稿后的保护性外扩删除式复核，只删无独立论证作用的整句或可分离尾部，疑问即保留，不新增 Hook 或自动改写。四个 provider 的探索与扩大确认共得到 19 个完整配对，候选 11 胜、基线 0 胜、8 平，零硬回退；证据见 `tests/evidence/protective-expansion-delete-only-20260822/RESULT.md`。
